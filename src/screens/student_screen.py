...
from src.database.db import get_all_student,create_student,get_student_attendance,enroll_student_to_subject,unenroll_student_to_subject,get_student_subjects
from src.components.dialog_enroll import enroll_subject
...
def student_screen():
    ...
    st.space()
    photo_source=st.camera_input("Postion your Face to Capture")
    if photo_source:
    ...
    if st.session_state.show_registration:
        with st.container(border=True):
            ...
            audio_data=None
            try:
                audio_data=st.audio_input("Record a short phrase like My name is Riya ,I am present.")
            except Exception:
